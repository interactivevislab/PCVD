...
/** @defgroup altTrackingAlignmentModule Alt Tracking Alignment Module
 * This module provides functionality to work with the Antilatency Alt Tracking Alignment library.
 *  @{
 */
