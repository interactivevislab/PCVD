...
public:
    ...
    FTrackingAlignmentState(const Antilatency::TrackingAlignment::State native) {
        RotationARelativeToB = FQuat(native.rotationARelativeToB.z, native.rotationARelativeToB.x, native.rotationARelativeToB.y, native.rotationARelativeToB.w);
        RotationBSpace = FQuat(native.rotationBSpace.z, native.rotationBSpace.x, native.rotationBSpace.y, native.rotationBSpace.w);
		TimeBAheadOfA = native.timeBAheadOfA;
    }

    FTrackingAlignmentState(const FQuat& rotationARelativeToB, const FQuat& rotationBSpace, const float timeBAheadOfA) : RotationARelativeToB(rotationARelativeToB), RotationBSpace(rotationBSpace), TimeBAheadOfA(timeBAheadOfA) {}

    Antilatency::TrackingAlignment::State ToNative() const {
        Antilatency::TrackingAlignment::State result;
        result.rotationARelativeToB = { RotationARelativeToB.Y, RotationARelativeToB.Z, RotationARelativeToB.X, RotationARelativeToB.W };
        result.rotationBSpace = { RotationBSpace.Y, RotationBSpace.Z, RotationBSpace.X, RotationBSpace.W };
		result.timeBAheadOfA = double{ TimeBAheadOfA };
