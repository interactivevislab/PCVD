...
{
	HARDWAREEXTENSIONINTERFACE_LOG(Log, TEXT("IAntilatencyHardwareExtensionInterfaceModule: PreUnloadCallback"));
	if (_library != nullptr) {
...
Antilatency::HardwareExtensionInterface::ILibrary IAntilatencyHardwareExtensionInterfaceModule::GetNativeLibrary()
{
    ...
    if (_library == nullptr) {
		HARDWAREEXTENSIONINTERFACE_LOG(Error, TEXT("Failed to get Antilatecy Hardware Extension Interface ILibrary"));
    }
