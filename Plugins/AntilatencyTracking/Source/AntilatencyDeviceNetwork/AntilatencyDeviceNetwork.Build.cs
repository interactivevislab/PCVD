...
namespace UnrealBuildTool.Rules {
	public class AntilatencyDeviceNetwork : ModuleRules {
		public AntilatencyDeviceNetwork(ReadOnlyTargetRules Target) : base(Target) {
            ...
            string PublicInclude = Path.Combine(BaseDirectory, "Source", "AntilatencyDeviceNetwork", "Public");
            string PrivateInclude = Path.Combine(BaseDirectory, "Source", "AntilatencyDeviceNetwork", "Private");
            ...
            if (Target.Platform == UnrealTargetPlatform.Win32 || Target.Platform == UnrealTargetPlatform.Win64) {
                ...
                string AplPath = Path.Combine(PluginPath, "AntilatencyDeviceNetwork_APL.xml");
#if UE_4_19_OR_LATER
