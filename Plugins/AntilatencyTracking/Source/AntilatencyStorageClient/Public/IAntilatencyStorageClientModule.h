...
/** @defgroup storageClientModule Antilatency Storage Client Module
 * This module provides functionality to work with the Antilatency Storage Client library.
 *  @{
 */
...
private:
    void* _antilatencyStorageClientDllHandle = nullptr;
