...
public:
    ...
    static void GetStorageClientLibrary(UStorageClientLibrary*& result, EStorageClientExceptionResult& exception);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Antilatency|StorageClient|Library", Meta = (ExpandEnumAsExecs = "exception"))
    static void GetRemoteStorage(const UStorageClientLibrary* storageClientLibrary, const FString& ipAddress, int32 port, UStorage*& result, EStorageClientExceptionResult& exception);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Antilatency|StorageClient|Library", Meta = (ExpandEnumAsExecs = "exception"))
    static void GetLocalStorage(const UStorageClientLibrary* storageClientLibrary, UStorage*& result, EStorageClientExceptionResult& exception);
    ...
    static void Read(const UStorage* storage, const FString& group, const FString& key, FString& result, EStorageClientExceptionResult& exception);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Antilatency|StorageClient|Storage", Meta = (ExpandEnumAsExecs = "exception"))
    static void Write(const UStorage* storage, const FString& group, const FString& key, const FString& data, EStorageClientExceptionResult& exception);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Antilatency|StorageClient|Storage", Meta = (ExpandEnumAsExecs = "exception"))
    static void Remove(const UStorage* storage, const FString& group, const FString& key, EStorageClientExceptionResult& exception);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Antilatency|StorageClient|Storage", Meta = (ExpandEnumAsExecs = "exception"))
    static void Next(const UStorage* storage, const FString& group, const FString& key, FString& result, EStorageClientExceptionResult& exception);
